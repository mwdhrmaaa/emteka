...
<div class="relative overflow-hidden pt-16 pb-32">
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="mt-20 grid grid-cols-1 gap-8 sm:grid-cols-3">
            <div class="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition-all hover:border-primary/50 hover:bg-white/10">
            ...
            <div class="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition-all hover:border-secondary/50 hover:bg-white/10">
